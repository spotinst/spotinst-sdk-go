...
type Scaler struct {
	...
	TerminationPolicies []*TerminationPolicie `json:"terminationPolicies,omitempty"`
...
type TerminationPolicie struct {
...
func (o *Scaler) SetTerminationPolicies(v []*TerminationPolicie) *Scaler {
...
func (o TerminationPolicie) MarshalJSON() ([]byte, error) {
	type noMethod TerminationPolicie
	raw := noMethod(o)
	return jsonutil.MarshalJSON(raw, o.forceSendFields, o.nullFields)
}

func (o *TerminationPolicie) SetStatements(v []*Statement) *TerminationPolicie {
